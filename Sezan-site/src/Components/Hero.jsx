           ...
           <section className="pl-[40px] mt-[70px]">
             ...
             <p className="w-[576px] h-[84px] text-xl tracking-[1px] leading-[1.2] text-[#64748B] mt-[20px] mb-[20px] font-normal">Experience the future of fluid shopping. We blend <br />arhitectural precision with liquid editorial  deign to curate <br />the world's most sought-after essentials  </p>
               <div className="flex flex-row gap-4">
                <Link to = "./ "><button className="bg-gradient-to-r from-[#3132ED] to-[#5054FF] text-white  rounded-[8px]  w-[184px] h-[56px] justify-center items-center shadow-md hover:from-red-500 hover:to-red-600 transition-all duration-300  hover:scale-105 flex flex-row items-center gap-2 cursor-pointer"> <span>Shop Now</span><img src={arrow} alt="" /></button></Link>
                <Link to = "./"><button className="bg-[#FFFFFF] text-[#3132ED] w-[184px] h-[56px] justify-center items-center font-medium shadow-md hover:bg-red-500 transition duration-300 flex flex-row items-center gap-2 cursor-pointer"> <span>Browse site</span></button></Link>
              </div>
            </section>
